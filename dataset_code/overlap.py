...
input_path1 = r"D:\STUDY IN FRANCE\STUDY NOW\robot_project\test1"  # source path
input_path2 = r"D:\STUDY IN FRANCE\STUDY NOW\robot_project\test2"  # source path
output_path = r"D:\STUDY IN FRANCE\STUDY NOW\robot_project\test"  # output path
